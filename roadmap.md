...
- Bootstrap `text-info` class replaced with AfA earthy green in policy description.
...
Each alarm indicator uses a geometric shape and AfA palette colour:

| State | Shape | Colour | Meaning |
|-------|-------|--------|---------|
| Controlled | Circle | AfA sea green `#3EA27F` | Situation under control |
| Warning | Triangle | AfA orange `#F59342` | Attention required |
| Critical | Square | AfA dark red `#752111` | Situation out of control |
...
- AfA-branded navbar with Home button (same style as all other views).
...
modelling platform** with a UI fully aligned with AfA brand guidelines. The technical and UX
